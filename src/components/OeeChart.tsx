      ...
      <div className="h-72">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
            ...
            <YAxis stroke="#cbd5e1" fontSize={12} tick={{ fill: '#e2e8f0' }} tickLine={false} domain={[50, 100]} tickFormatter={(v) => `${v}%`} />
            <Tooltip
              contentStyle={{
            ...
            />
            <ReferenceLine y={85} stroke="#10b981" strokeDasharray="2 2" strokeOpacity={0.6} />
